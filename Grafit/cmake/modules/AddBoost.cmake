...
set(BoostVersion 1.62.0)
set(BoostSHA1 5fd97433c3f859d8cbab1eaed4156d3068ae3648)
...
if(NOT b2Path)
  ...
  if(MSVC)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "^(Apple)?Clang$")
      list(APPEND b2Bootstrap --with-toolset=clang --with-python=python)
    elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
      list(APPEND b2Bootstrap --with-toolset=gcc --with-python=python --without-icu)
    endif()
  endif()
...
#  message(FATAL_;ERROR "Remove patched files from the source tree and delete corresponding 'configure_file' commands in this 'add_boost' CMake file.")
#endif()
...
execute_process(COMMAND ./b2 --show-libraries WORKING_DIRECTORY ${BoostSourceDir}
                OUTPUT_VARIABLE Output ERROR_VARIABLE ErrorVar)
