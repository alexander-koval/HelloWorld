...
/// (Vector2 and Vector3).
///
/// To keep things simple, gf::Rect doesn't define
...
///
/// This means that gf::IntRect(0, 0, 1, 1) and gf::IntRect(1, 1, 1, 1)
/// don't intersect.
///
...
/// \li gf::Rect<int> is gf::IntRect
/// \li gf::Rect<float> is gf::FloatRect
///
