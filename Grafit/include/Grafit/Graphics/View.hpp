...
public:
    ...
    /// be defined with View.setViewport(gf::FloatRect(0, 0, 0.5, 1)).
...
/// Usage example:
/// \code
/// gf::RenderWindow window;
/// gf::View view;
/// 
/// // Initialize the view to a rectangle located at (100, 100) and with a size of 400x200
/// view.reset(gf::FloatRect(100, 100, 400, 200));
///
/// // Rotate it by 45 degrees
/// view.rotate(45);
///
/// // Set its target viewport to be half of the window
/// view.setViewport(gf::FloatRect(0.f, 0.f, 0.5f, 1.f));
///
/// // Apply it
/// window.setView(view);
///
...
/// \endcode
///
/// See also the note on coordinates and undistorted rendering in gf::Transformable.
///
/// \see gf::RenderWindow, gf::RenderTexture
///
////////////////////////////////////////////////////////////
