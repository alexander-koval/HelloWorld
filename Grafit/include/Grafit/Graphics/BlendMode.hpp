...
/// \ingroup graphics
///
/// gf::BlendMode is a class that represents a blend mode. A blend
...
/// gf::BlendMode multiplicativeBlending = gf::BlendMultipy;
/// gf::BlendMode noBlending             = gf::BlendNone;
/// \endcode
///
/// In SFML, a blend mode can be specified every time you draw a gf::Drawable
/// object to a render target. It is part of the gf::RenderStates compound
/// that is passed to the member function gf::RenderTarget::draw().
///
/// \see gf::RenderStates, gf::RenderTarget
///
////////////////////////////////////////////////////////////
